...
const GLOBAL_CSS = `
  ...
  :root {
    ...
    --sux-navy3:     #111827;
    --sux-cyan:      #00D4FF;
    --sux-cyan-dim:  rgba(0,212,255,0.12);
    --sux-amber:     #F59E0B;
    --sux-amber-dim: rgba(245,158,11,0.1);
    --sux-ash:       #E2E8F0;
    --sux-ash2:      #94A3B8;
    --sux-muted:     #4A5568;
    --sux-border:    rgba(226,232,240,0.08);
    --sux-border2:   rgba(0,212,255,0.15);
  }

  .sux {
    font-family: 'Space Mono', monospace;
    background: var(--sux-navy);
    color: var(--sux-ash);
    font-size: 15px;
    line-height: 1.85;
  }
  ...
  .sux-sec-num {
    ...
    text-transform: uppercase; color: var(--sux-cyan);
    flex-shrink: 0; font-family: 'Space Mono', monospace;
  }
  .sux-sec-line { flex: 1; height: 1px; background: var(--sux-border); }
  .sux-h2 {
    font-family: 'DM Serif Display', serif;
    font-size: clamp(26px, 3vw, 38px); font-weight: 400;
    color: var(--sux-ash); letter-spacing: -0.02em; line-height: 1.2;
  }
  .sux-sec-label {
    font-size: 9px; letter-spacing: 0.2em;
    text-transform: uppercase; color: var(--sux-amber);
  ...
  .sux-p {
    ...
    color: var(--sux-ash2); line-height: 1.9;
    margin-bottom: 22px;
  }
  .sux-p:last-child { margin-bottom: 0; }
  .sux-p strong { font-weight: 700; color: var(--sux-ash); }
  .sux-p em { font-style: italic; color: var(--sux-ash); }

  /* ══ PULL QUOTE ══ */
  .sux-pull {
    margin: 52px 0;
    padding: 32px 36px;
    background: var(--sux-navy2);
    border: 1px solid var(--sux-border2);
    border-radius: 6px;
  ...
  .sux-pull::before {
    ...
    background: linear-gradient(180deg, var(--sux-cyan), var(--sux-amber));
  }
  .sux-pull-text {
    font-family: 'DM Serif Display', serif;
    font-size: clamp(20px, 2.5vw, 27px);
    font-style: italic; color: var(--sux-ash);
    line-height: 1.45;
  }
  .sux-pull-attr {
    display: block; font-size: 10px;
    letter-spacing: 0.12em; color: var(--sux-muted);
  ...
  .sux-callout {
    background: var(--sux-navy2);
    border: 1px solid var(--sux-border);
    border-left: 2px solid var(--sux-amber);
  ...
  .sux-callout li {
    ...
    font-size: 13px; color: var(--sux-ash2); line-height: 1.65;
  }
  .sux-callout li::before {
    content: '—'; color: var(--sux-cyan);
  ...
  .sux-stats {
    ...
    gap: 1px; background: var(--sux-border);
    border: 1px solid var(--sux-border);
  ...
  .sux-stat-num {
    ...
    color: var(--sux-cyan); line-height: 1;
    margin-bottom: 10px; letter-spacing: -0.02em;
  }
  .sux-stat-label {
    font-size: 11px; color: var(--sux-muted); line-height: 1.5;
  }
  ...
  .sux-case-head {
    background: var(--sux-navy3);
    border-bottom: 1px solid var(--sux-border);
    padding: 14px 22px;
  ...
  .sux-case-badge {
    ...
    color: var(--sux-amber); border: 1px solid rgba(245,158,11,0.4);
    border-radius: 2px; padding: 3px 10px;
  }
  .sux-case-title {
    font-family: 'Instrument Sans', sans-serif;
    font-size: 13px; font-weight: 600; color: var(--sux-ash);
  }
  .sux-case-company {
    font-size: 10px; letter-spacing: 0.1em;
    color: var(--sux-cyan); text-transform: uppercase;
  }
  .sux-case-body { padding: 28px; background: var(--sux-navy2); }
  ...
  .sux-highlight h3 {
    font-family: 'DM Serif Display', serif;
    font-size: 22px; color: var(--sux-ash);
    margin-bottom: 14px; line-height: 1.3;
  }
  .sux-highlight p {
    font-size: 13.5px; color: var(--sux-ash2); line-height: 1.75;
  }

  /* ══ NOTE ══ */
  .sux-note {
    background: var(--sux-amber-dim);
    border-left: 2px solid var(--sux-amber);
  ...
  .sux-large-q {
    ...
    line-height: 1.2; color: var(--sux-ash);
    padding: 52px 0;
    border-top: 1px solid var(--sux-border);
    border-bottom: 1px solid var(--sux-border);
    margin: 52px 0; letter-spacing: -0.01em;
  }
  .sux-large-q span { color: var(--sux-cyan); }

  /* ══ COMPARISON TABLE ══ */
  .sux-table-wrap { overflow-x: auto; margin: 34px 0; border-radius: 6px; border: 1px solid var(--sux-border); }
  .sux-table {
    width: 100%; border-collapse: collapse;
    background: var(--sux-navy2); font-size: 13px; min-width: 500px;
  }
  .sux-table thead tr { background: var(--sux-navy3); }
  .sux-table thead th {
    font-size: 9px; letter-spacing: 0.18em; text-transform: uppercase;
    padding: 13px 18px; text-align: left; font-weight: 400; color: var(--sux-ash2);
    border-bottom: 1px solid var(--sux-border);
  }
  .sux-table tbody tr { border-bottom: 1px solid rgba(226,232,240,0.04); }
  .sux-table tbody tr:last-child { border-bottom: none; }
  .sux-table td { padding: 13px 18px; color: var(--sux-ash2); }
  .sux-table td:first-child { font-weight: 700; color: var(--sux-ash); }
  ...
  .sux-pr-card:hover { border-color: var(--sux-border2); transform: translateY(-2px); }
  .sux-pr-num {
    font-family: 'DM Serif Display', serif;
    font-size: 32px; color: var(--sux-cyan-dim);
    line-height: 1; margin-bottom: 10px;
  }
  .sux-pr-card h3 {
    font-family: 'Instrument Sans', sans-serif;
    font-size: 15px; font-weight: 600; color: var(--sux-ash);
    margin-bottom: 7px; line-height: 1.3;
  }
  .sux-pr-card p { font-size: 12px; color: var(--sux-muted); line-height: 1.65; margin: 0; }
  ...
  .sux-wave-bar {
    width: 3px; background: var(--sux-cyan);
  ...
  .sux-sound-header-title {
    font-family: 'Instrument Sans', sans-serif;
    font-size: 14px; font-weight: 600; color: var(--sux-ash);
  }
  .sux-sound-header-sub {
    font-size: 11px; color: var(--sux-muted); margin-left: auto;
  ...
  .sux-sound-desc {
    font-size: 11px; color: var(--sux-muted); line-height: 1.4;
  }
  .sux-sound-brand {
    font-size: 10px; letter-spacing: 0.1em;
    text-transform: uppercase; color: var(--sux-cyan);
...
const SOUND_PRESETS = {
  apple_success: (ctx) => {
    ...
    setTimeout(
      () => playTone(ctx, { type: 'sine', freq: 659, duration: 0.22, gain: 0.22, attack: 0.005 }),
      120,
    );
    return 400;
  },
  ...
  slack_pop: (ctx) => {
    ...
    setTimeout(
      () => playTone(ctx, { type: 'sine', freq: 1100, duration: 0.1, gain: 0.2, attack: 0.002 }),
      60,
    );
    return 300;
  },
  slack_sent: (ctx) => {
    playSequence(ctx, [{ freq: 784, dur: 0.08, gap: 0.02 }, { freq: 988, dur: 0.1, gap: 0 }], {
      type: 'sine',
      gain: 0.22,
      attack: 0.003,
    });
  ...
  nintendo_1up: (ctx) => {
    playSequence(
      ctx,
      [
        { freq: 523, dur: 0.08, gap: 0.01 },
        { freq: 659, dur: 0.08, gap: 0.01 },
        { freq: 784, dur: 0.08, gap: 0.01 },
        { freq: 1047, dur: 0.15, gap: 0 },
      ],
  ...
  zelda_secret: (ctx) => {
    playSequence(
      ctx,
      [
        { freq: 392, dur: 0.1, gap: 0.02 },
        { freq: 523, dur: 0.1, gap: 0.02 },
        { freq: 659, dur: 0.1, gap: 0.02 },
  ...
  whatsapp_receive: (ctx) => {
    ...
    setTimeout(
      () => playTone(ctx, { type: 'sine', freq: 880, duration: 0.09, gain: 0.25, attack: 0.002 }),
      80,
    );
    return 300;
  },
  ...
  coin: (ctx) => {
    ...
    setTimeout(
      () => playTone(ctx, { type: 'square', freq: 1319, duration: 0.15, gain: 0.22, attack: 0.001 }),
      40,
    );
    return 350;
  },
  soft_confirm: (ctx) => {
    ...
    setTimeout(
      () => playTone(ctx, { type: 'sine', freq: 523, duration: 0.18, gain: 0.2, attack: 0.01 }),
      100,
    );
    return 400;
  },
...
const STATS = [
  ...
  {
    num: '3×',
    label: 'faster emotional response to audio feedback vs. visual feedback alone',
  },
...
const PRINCIPLES = [
  {
    ...
    body: 'Every sound must earn its place by carrying information. If removing it changes nothing for the user, remove it.',
  },
  {
    num: '02',
    title: 'Consistent Vocabulary',
    body: 'Rising tones signal success; descending tones signal error. Establish a grammar and never break it without reason.',
  },
  {
    num: '03',
    title: 'Proportional to Importance',
    body: 'Critical alerts are louder and more complex. Routine feedback is subtle. Hierarchy in audio mirrors hierarchy in visual design.',
  },
  {
    num: '04',
    title: 'Respectful of Context',
    body: 'Design for silent mode. Every audio interaction must have a visual equivalent. Never assume the user can hear.',
  },
  {
    num: '05',
    title: 'Culturally Considered',
    body: 'Sound carries cultural meaning. A tone that signals success in one context may signal alarm in another. Test across cultures.',
  },
  {
    num: '06',
    title: 'Off by Default or Opt-In',
    body: 'For ambient or expressive sounds, give users control. Autonomy over audio is a basic UX courtesy.',
  },
];

function WaveBars({ playing, count = 10, color }) {
  const heights = [40, 70, 55, 85, 45, 90, 60, 75, 50, 65, 80, 40, 70, 55, 85].slice(0, count);
  return (
        ...
        {sounds.map((s) => (
          <div key={s.id} className="sux-sound-item" onClick={() => handlePlay(s.id, s.preset)}>
            ...
            <div className="sux-sound-viz">
              <WaveBars playing={playing === s.id} count={12} color={s.color || 'var(--sux-cyan)'} />
            </div>
          </div>
        ))}
      </div>
...
function P({ children }) {
  return <p className="sux-p">{children}</p>;
}
...
export default function SoundAsUX() {
  const title = 'Sound as UX';
  const description = 'The criminally underinvested discipline of audio design in digital products — and the companies doing it right.';

  return (
    <EditorialLayout
      toc={TOC}
      className="sux"
      progressColor="var(--sux-cyan)"
      heroData={{
        eyebrow: 'Audio Design · UX Craft · Product Experience',
        title: 'Sound as <em>UX</em>',
        subtitle:
          'The criminally underinvested discipline of audio design in digital products — and the companies doing it right.',
        meta: ['May 2026', '8 min read', 'Deep Dive + Interactive'],
        tags: ['Audio UX', 'Sound Design', 'Product Design', 'Case Studies', 'Interactive'],
      }}
    >
      <SEO
        title={title}
        ...
        url="https://braxtonmandara.com/mandara/blogs/sound-as-ux"
        type="article"
      />
      ...
      <PullQuote attr="— The core argument for audio UX investment">
        ...
        interface is a missed opportunity to communicate, reassure, and delight — at the speed of
        feeling."
      </PullQuote>
      ...
      <SecMarker
        ...
        num="01"
        label="The Problem"
        title="The Silent Crisis in Digital Design"
      />
      <Reveal className="editorial-reveal">
        <P>
          ...
          their design budget to audio. The average app has fewer than three distinct sounds, all of
          them sourced from system defaults or stock libraries. Most enterprise software has none.
        </P>
      </Reveal>
      ...
      <Reveal className="editorial-reveal">
        <div className="sux-highlight">
          ...
          <p>
            Designers working in audio UX use the term <strong>earcon</strong> — the audio
            equivalent of an icon. Just as an icon is a compressed visual symbol that carries
            meaning without words, an earcon is a brief audio signal that communicates a specific
            state or action. The best earcons are immediately recognizable, emotionally congruent
            with their meaning, and distinct enough to be identified even in noisy environments.
            Designing a good earcon requires the same systematic thinking as designing a good icon —
            and the same rigor in testing whether it communicates what it's meant to communicate.
          </p>
        </div>
      </Reveal>
      ...
      <Reveal className="editorial-reveal">
        <P>
          What makes a UX sound good? The answer is more precise than most designers expect. Audio
          UX operates with a vocabulary of acoustic parameters — frequency, duration, timbre,
          ...
          <table className="sux-table">
            ...
            <tbody>
              {[
                ...
                <tr key={a}>
                  <td>{a}</td>
                  <td style={{ color: 'var(--sux-ash2)' }}>{b}</td>
                  <td style={{ color: 'var(--sux-ash2)' }}>{c}</td>
                  <td style={{ color: 'var(--sux-cyan)' }}>{d}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          sounds={[
            {
              id: 's1',
              name: 'Success Tone',
              desc: "Ascending two-note — warm sine wave. Communicates 'done, proceed'.",
              brand: 'Apple-style',
              preset: 'apple_success',
              color: '#4ADE80',
            },
            {
              id: 's2',
              name: 'Error Tone',
              desc: "Low descending sawtooth — signals 'stop, something's wrong'.",
              brand: 'System UI',
              preset: 'apple_error',
              color: '#F87171',
            },
            {
              id: 's3',
              name: 'Soft Confirm',
              desc: 'Gentle ascending chord — minimal, non-intrusive acknowledgment.',
              brand: 'Ambient UI',
              preset: 'soft_confirm',
              color: '#00D4FF',
            },
            {
              id: 's4',
              name: 'Error Buzz',
              desc: 'Low-frequency buzz — visceral, impossible to miss or misread.',
              brand: 'Alert System',
              preset: 'error_buzz',
              color: '#F59E0B',
            },
      ...
      <CaseStudy company="Apple Inc." title="Building a Sonic Identity Across a Decade">
        <P>
          ...
          Beginning with the original Macintosh startup chime in 1984, designed by Jim Reekes, Apple
          has treated sound as a first-class design material, applying the same systematic thinking
          to its audio vocabulary that it applies to its visual one.
        </P>
        <P>
          ...
          range that sits comfortably above the noise floor of most environments — typically between
          800Hz and 1.2kHz for primary feedback tones.
        </P>
        <P>
          What distinguishes Apple's approach is not just the quality of individual sounds but the
          coherence of the system. Success states, error states, notifications, and transitions
          share a recognizable tonal family — related by harmonic content and attack character even
          when they differ in pitch and duration. The result is a sonic language that feels unified
          even as it communicates a wide range of states.
        </P>
        <P>
          Apple's investment in this discipline is substantial. The company employs dedicated sound
          designers who work in close collaboration with hardware engineers (sound design changes
          with hardware resonance characteristics), software interaction designers, and
          ...
          sounds={[
            {
              ...
              desc: 'The two-note ascending pattern that signals an incoming message. Warm, clear, non-alarming.',
              brand: 'iOS',
              preset: 'apple_success',
              color: '#4ADE80',
            },
            {
              id: 'a2',
              name: 'Mac Startup Chord',
              desc: 'A major chord with slow attack and long sustain. Ceremonial, warm, familiar. One of the most recognized sounds in tech.',
              brand: 'macOS',
              preset: 'mac_startup',
              color: '#00D4FF',
            },
            {
              id: 'a3',
              name: 'UI Error State',
              desc: "Short descending tone. Communicates 'invalid input' without alarm or shame.",
              brand: 'iOS / macOS',
              preset: 'apple_error',
              color: '#F87171',
            },
      ...
      <CaseStudy company="Nintendo" title="When Audio UX Becomes Cultural Memory">
        <P>
          ...
          the boundary between UI sound and narrative sound. In most digital products, audio UX is
          strictly functional — feedback, alerts, notifications. In Nintendo's products, the sonic
          vocabulary of the interface becomes indistinguishable from the sonic vocabulary of the
          experience itself. The coin collect sound in Mario is simultaneously a reward signal, a
          score increment notification, and a piece of world-building.
        </P>
        <P>
          ...
          discovery chime, the Pokémon level-up fanfare: these are not merely feedback tones. They
          are emotionally conditioned reward signals that have been reinforced through hundreds of
          hours of positive association.
        </P>
        <P>
          The lesson for product designers is not "add 8-bit sounds to your app." It is:{' '}
          <strong>
            sounds that carry narrative meaning become emotionally sticky in ways that purely
            functional sounds do not.
          </strong>{' '}
          When a sound is associated with a moment of success, discovery, or reward, it accumulates
          emotional charge with each repetition. That charge becomes brand equity.
        </P>
      </CaseStudy>
          ...
          sounds={[
            {
              id: 'n1',
              name: '1-Up Mushroom',
              desc: 'Four ascending square-wave notes. One of the most universally recognized reward sounds ever designed.',
              brand: 'Super Mario',
              preset: 'nintendo_1up',
              color: '#4ADE80',
            },
            {
              ...
              desc: "The ascending four-note chime that signals 'you found something hidden.' Pure positive reinforcement.",
              brand: 'Zelda Series',
              preset: 'zelda_secret',
              color: '#F59E0B',
            },
            {
              id: 'n3',
              name: 'Coin Collect',
              desc: 'Short, bright, percussive. Hundreds of millions of people know exactly what this means.',
              brand: 'Super Mario',
              preset: 'coin',
              color: '#00D4FF',
            },
      ...
      <SecMarker
        ...
        num="06"
        label="Case Study"
        title="Slack & Discord: The Social Soundscape"
      />
      <CaseStudy company="Slack / Discord" title="Designing Sound for Ambient Awareness">
        <P>
          ...
          that is even slightly grating will cause users to mute the app entirely — losing all audio
          feedback permanently. A sound that is too quiet will be missed, causing users to feel
        ...
        <P>
          ...
          electronic. The notification pop is brief (under 100ms), pitched in a mid-range that cuts
          through ambient noise without dominating it, and shaped with a fast attack and slow decay
          that gives it a percussive quality without harshness.
        </P>
        <P>
          Discord took a different approach, targeting a younger, gaming-adjacent audience with
          higher tolerance for expressive sound design. The join/leave sounds in voice channels — a
          brief ascending or descending sweep — are distinctive enough to communicate state changes
          unambiguously even in chaotic multi-tab browser environments. They have become so
          associated with Discord's brand that they are instantly recognizable to hundreds of
          millions of users.
        </P>
      </CaseStudy>
          ...
          sounds={[
            {
              ...
              desc: "Slack's signature pop — brief, warm, organic. Designed to feel like a gentle tap on the shoulder, not an alarm.",
              brand: 'Slack',
              preset: 'slack_pop',
              color: '#4ADE80',
            },
            {
              id: 'm2',
              name: 'Message Sent',
              desc: "Confirmation of send action — two ascending notes. 'Your message is on its way.'",
              brand: 'Slack',
              preset: 'slack_sent',
              color: '#00D4FF',
            },
            {
              id: 'm3',
              name: 'User Joined Voice',
              desc: "Ascending sweep — 'someone arrived.' Discord's most recognized sound.",
              brand: 'Discord',
              preset: 'discord_join',
              color: '#7C3AED',
            },
            {
              ...
              desc: 'The double-tone notification that signals a new message. Billions of daily exposures.',
              brand: 'WhatsApp',
              preset: 'whatsapp_receive',
              color: '#25D366',
            },
          ]}
        />
      ...
      <Reveal className="editorial-reveal">
        <P>
          For every Apple and Nintendo, there are a hundred products that have gotten audio UX badly
          wrong — and understanding these failures is as instructive as studying the successes. The
          pathologies of bad audio UX are remarkably consistent.
        </P>
      </Reveal>
      ...
      <Reveal className="editorial-reveal">
        <P>
          The most damaging failure is also the most common: treating audio as a feature to be added
          at the end of development rather than a design dimension to be considered from the
          beginning. Sound that is retrofitted onto an already-completed interaction model almost
          always feels incongruent — because it was not considered when the interaction's timing,
          rhythm, and emotional arc were being designed. Good audio UX is co-designed with the
          interaction, not applied to it afterward.
        </P>
      </Reveal>

      <Reveal className="editorial-reveal">
        <div className="sux-large-q">
          The question is never "should we add sound to this?" The question is{' '}
          <span>"what is this moment already communicating, and how does sound complete it?"</span>
        </div>
      </Reveal>
      ...
      <Reveal className="editorial-reveal">
        <P>
          Underlying all of these principles is a single truth: <strong>audio UX is not about adding
          sounds to a product. It is about designing a complete sensory experience where every
          channel — visual, haptic, and auditory — communicates coherently.</strong>{' '}
          The absence of sound is itself a design decision. It should be made intentionally, not by
          default.
        </P>
      </Reveal>
      ...
      <Reveal className="editorial-reveal">
        <P>
          Three forces are converging to push audio UX from a niche concern to a mainstream design
          discipline. The first is the rise of voice-native and ambient interfaces — smart speakers,
          earbuds, AR glasses — where sound is the primary output channel and visual design is
          secondary or absent. Designers who have not developed audio UX competencies will be unable
          to practice effectively in these environments.
        </P>
        <P>
          The second is the maturation of generative audio AI. Systems like ElevenLabs, Suno, and
          Adobe's audio tools are making high-quality sound design accessible without requiring
          years of acoustic engineering expertise. This democratization will lower the barrier to
          entry for audio UX — but it will also flood markets with mediocre, generic sound design
          generated by teams who haven't developed the underlying principles. As with visual AI
          tools, the advantage will go to designers who understand the craft well enough to direct
          and evaluate AI output, not just generate it.
        </P>
        <P>
          The third force is accessibility. As voice interfaces become primary for users with visual
          impairments, and as haptic feedback reaches its physical limits on thin mobile hardware,
          audio becomes the most important remaining channel for communicating product state to the
          full range of users. The legal and ethical pressure to design accessible audio experiences
          — not just accessible visual ones — is building steadily.
        </P>
      </Reveal>
      ...
      <PullQuote attr="— On the near future of audio UX">
        ...
        interface needs a visual designer today. The products that invest now will own the emotional
        vocabulary of whatever comes next."
      </PullQuote>

      <Reveal className="editorial-reveal">
        <P>
          The companies profiled in this piece — Apple, Nintendo, Slack, Discord — did not invest in
          audio UX because they had spare budget. They invested because they understood that every
          sensory channel is a relationship channel. Sound is how a product says <em>I see you, I
          heard you, you're on the right track.</em> In a world of increasing digital noise, the
          product that knows when to speak and what to say — and how to say it in 200 milliseconds —
          will be the one users come back to.
        </P>
        <P>
          ...
          sounds={[
            {
              id: 'f1',
              name: 'Task Complete',
              desc: "Mid-range ascending — 'you're done, move forward.'",
              brand: 'Success',
              preset: 'soft_confirm',
              color: '#4ADE80',
            },
            {
              id: 'f2',
              name: 'Critical Error',
              desc: 'Low-frequency alert — impossible to miss, communicates urgency without panic.',
              brand: 'Error',
              preset: 'error_buzz',
              color: '#F87171',
            },
            {
              ...
              desc: "Rising sequence — 'you achieved something meaningful.' Dopamine-triggering by design.",
              brand: 'Achievement',
              preset: 'nintendo_1up',
              color: '#F59E0B',
            },
            {
              id: 'f4',
              name: 'New Message',
              desc: "Non-intrusive notification — 'something awaits when you're ready.'",
              brand: 'Notify',
              preset: 'slack_pop',
              color: '#00D4FF',
            },
            {
              ...
              desc: "Four-note ascending chime — 'you found something hidden.' Pure positive reinforcement.",
              brand: 'Delight',
              preset: 'zelda_secret',
              color: '#A78BFA',
            },
      ...
      <Reveal className="editorial-reveal">
        <div
          style={{
            marginTop: 100,
            paddingTop: 30,
            borderTop: '1px solid var(--sux-border)',
            display: 'flex',
        ...
        >
          <span
            style={{ fontSize: 10, letterSpacing: '0.14em', color: 'var(--sux-muted)', textTransform: 'uppercase' }}
          >
            Sound Design · UX Craft · May 2026
          </span>
          <button
            className="sux-top-btn"
